    ...
    <el-form ref="form" :rules="rules" :model="form" label-width="80px" label-position="right">
      ...
      <el-form-item label="上传头像">
        <el-upload
          ...
          <img v-if="this.imgUrl" :src="require('../../assets/'+this.imgUrl+'.JPG')" class="avatar">
  ...
  export default {
    ...
    methods: {
      ...
      handleAvatarSuccess(res) {
        console.log(res)
        this.imgUrl=res.substring(0,res.length-4)
        this.info.picture=res.substring(0,res.length-4)
      },
